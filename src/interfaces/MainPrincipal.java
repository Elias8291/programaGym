...
public class MainPrincipal extends javax.swing.JFrame {
    ...
    public MainPrincipal() {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("/recursosGraficos/188882.png")).getImage());
        this.setTitle("GYM OAXACA");
    ...
    private void initComponents() {
        ...
        escudoUnam.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursosGraficos/gymPumaAragon_1.jpg"))); // NOI18N

        tablaPrincipal.setAutoCreateRowSorter(true);
        tablaPrincipal.setBackground(new java.awt.Color(153, 204, 255));
        tablaPrincipal.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        tablaPrincipal.setForeground(new java.awt.Color(0, 51, 102));
        ...
        btnActualizarTabla.setBackground(new java.awt.Color(0, 0, 0));
        ...
        panelInformacion.setBackground(new java.awt.Color(204, 204, 255));
        panelInformacion.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panelInformacion.setForeground(new java.awt.Color(153, 255, 204));
        ...
        lblTelefono.setForeground(new java.awt.Color(51, 0, 51));
        lblTelefono.setText("-");
        ...
        lblDireccion.setForeground(new java.awt.Color(51, 0, 51));
        ...
        menuMain.setForeground(new java.awt.Color(142,185,228));
        ...
        registrarUsuario.setBackground(new java.awt.Color(204, 204, 255));
        registrarUsuario.setForeground(new java.awt.Color(0, 0, 102));
        ...
        modificarUsuario.setForeground(new java.awt.Color(0, 0, 102));
        ...
        renovarMembresia.setForeground(new java.awt.Color(0, 0, 102));
        ...
        menuProductos.setBackground(new java.awt.Color(255, 255, 204));
        menuProductos.setForeground(new java.awt.Color(167, 127, 246));
        ...
        listaProductos.setForeground(new java.awt.Color(0, 0, 102));
        ...
        registrarProductos.setForeground(new java.awt.Color(0, 0, 102));
        ...
        actualizarCantidad.setForeground(new java.awt.Color(0, 0, 102));
        ...
        editarProducto.setForeground(new java.awt.Color(0, 0, 102));
        ...
        venderProducto.setForeground(new java.awt.Color(0, 0, 102));
        ...
        menuReporteVentas.setBackground(new java.awt.Color(255, 255, 204));
        ...
        reporteVentas.setForeground(new java.awt.Color(0, 0, 102));
        ...
        registrarEquipos.setBackground(new java.awt.Color(204, 204, 255));
        ...
        objMenuRegistrarEquipo.setForeground(new java.awt.Color(0, 0, 51));
        ...
        menuAsistencias.setForeground(new java.awt.Color(0, 0, 102));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(57, 57, 57)
                        .addComponent(escudoUnam, javax.swing.GroupLayout.PREFERRED_SIZE, 446, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
          UIManager.put( "control", new Color( 246, 239, 148) );
          UIManager.put( "info", new Color(128,128,128) );
          UIManager.put( "nimbusBase", new Color( 18, 30, 49) );
          UIManager.put( "nimbusAlertYellow", new Color( 246, 239, 148) );
          UIManager.put( "nimbusDisabledText", new Color( 128, 128, 128) );
          UIManager.put( "nimbusFocus", new Color(115,164,209) );
          UIManager.put( "nimbusGreen", new Color(176,179,50) );
          UIManager.put( "nimbusInfoBlue", new Color( 66, 139, 221) );
          UIManager.put( "nimbusLightBackground", new Color( 242,170,245) );
          UIManager.put( "nimbusOrange", new Color(246, 239, 148) );
          UIManager.put( "nimbusRed", new Color(169,46,34) );
          UIManager.put( "nimbusSelectedText", new Color( 245,115,172) );
